...
@section("content")
    <div class="drafts" style="min-height: 500px">
        <div class="row">
            <div class="col">
                <div class="title fs-2 fw-bold text-danger mt-5">
                    DIRE
                </div>
            ...
            <div class="col">
                <div class="title fs-2 fw-bold text-success mt-5"  >
                    RADIANT
                </div>
    ...
    <div class="row mt-3">
        <div class="col">
            <div class="d-grid">
                <button type="submit" form="analyze" class="btn btn-outline-dark">Start</button>
            </div>
        </div>
    </div>
                    ...
                    @foreach($heroes as $hero)
                        <div class="hero">
                            ...
                            <div class="position-relative">
                                <button id="dire_btn" name="{{ $hero->hero_name }}" class="btn btn-outline-danger btn-sm position-absolute top-0 start-0">D</button>
                                <button id="radiant_btn" name="{{ $hero->hero_name }}" class="btn btn-outline-success btn-sm position-absolute bottom-0 start-0">R</button>
