...
@section("content")
    <div class="pt-3">
        <div class="container">
            <div class="row pb-3">
                <div class="col">
                    <button class="btn btn-dark w-100" type="button" data-bs-toggle="collapse" data-bs-target="#dotabuff" aria-expanded="false" aria-controls="dotabuff">
                        Dotabuff
                    </button>
                </div>
                <div class="col">
                    <button class="btn btn-dark w-100" type="button" data-bs-toggle="collapse" data-bs-target="#stratz" aria-expanded="false" aria-controls="stratz">
                        Stratz
                    </button>
                </div>
            </div>
